...
// SpatialClient is the client for the Spatial methods of the Creator service.
type SpatialClient struct {
    BaseClient
}
// NewSpatialClient creates an instance of the SpatialClient client.
func NewSpatialClient(xMsClientID string) SpatialClient {
    return SpatialClient{ New(xMsClientID)}
}
...
func (client SpatialClient) GetBuffer(ctx context.Context, udid string, distances string) (result BufferResponse, err error) {
    ...
    if err != nil {
    err = autorest.NewErrorWithError(err, "creator.SpatialClient", "GetBuffer", nil , "Failure preparing request")
    return
    }
        ...
        err = autorest.NewErrorWithError(err, "creator.SpatialClient", "GetBuffer", resp, "Failure sending request")
        return
        }

        result, err = client.GetBufferResponder(resp)
        if err != nil {
        err = autorest.NewErrorWithError(err, "creator.SpatialClient", "GetBuffer", resp, "Failure responding to request")
        return
        }
...
// udid returned by Data Upload API.
    // Parameters:
        ...
        // details. All the feature's properties should contain `geometryId`, which is used for identifying the
        // geometry and is case-sensitive.
        // latitude - the latitude of the location being passed.  Example: 48.36.
        // longitude - the longitude of the location being passed.  Example: -124.63.
        // numberOfClosestPoints - the number of closest points expected from response. Default: 1, minimum: 1 and
        // maximum: 50
func (client SpatialClient) GetClosestPoint(ctx context.Context, udid string, latitude float64, longitude float64, numberOfClosestPoints *int32) (result ClosestPointResponse, err error) {
    if tracing.IsEnabled() {
    ...
    req, err := client.GetClosestPointPreparer(ctx, udid, latitude, longitude, numberOfClosestPoints)
    if err != nil {
    err = autorest.NewErrorWithError(err, "creator.SpatialClient", "GetClosestPoint", nil , "Failure preparing request")
    return
    }
        ...
        if err != nil {
        result.Response = autorest.Response{Response: resp}
        err = autorest.NewErrorWithError(err, "creator.SpatialClient", "GetClosestPoint", resp, "Failure sending request")
        return
        }

        result, err = client.GetClosestPointResponder(resp)
        if err != nil {
        err = autorest.NewErrorWithError(err, "creator.SpatialClient", "GetClosestPoint", resp, "Failure responding to request")
        return
        }
    ...
    func (client SpatialClient) GetClosestPointPreparer(ctx context.Context, udid string, latitude float64, longitude float64, numberOfClosestPoints *int32) (*http.Request, error) {
        urlParameters := map[string]interface{} {
        "geography": autorest.Encode("path",client.Geography),
        }
    ...
    queryParameters := map[string]interface{} {
    "api-version": APIVersion,
    "lat": autorest.Encode("query",latitude),
    "lon": autorest.Encode("query",longitude),
    "udid": autorest.Encode("query",udid),
    }
...
autorest.WithQueryParameters(queryParameters))
    ...
    // closes the http.Response Body.
    func (client SpatialClient) GetClosestPointResponder(resp *http.Response) (result ClosestPointResponse, err error) {
            err = autorest.Respond(
            resp,
            azure.WithErrorUnlessStatusCode(http.StatusOK),
            autorest.ByUnmarshallingJSON(&result),
...
func (client SpatialClient) GetGeofence(ctx context.Context, deviceID string, udid string, latitude float64, longitude float64, z *float64, userTime *date.Time, searchBuffer *float64, isAsync *bool, mode GeofenceMode) (result GeofenceResponse, err error) {
    if tracing.IsEnabled() {
        ...
        return result, validation.NewError("creator.SpatialClient", "GetGeofence", err.Error())
        }

        req, err := client.GetGeofencePreparer(ctx, deviceID, udid, latitude, longitude, z, userTime, searchBuffer, isAsync, mode)
    if err != nil {
    err = autorest.NewErrorWithError(err, "creator.SpatialClient", "GetGeofence", nil , "Failure preparing request")
    return
    }
        ...
        if err != nil {
        result.Response = autorest.Response{Response: resp}
        err = autorest.NewErrorWithError(err, "creator.SpatialClient", "GetGeofence", resp, "Failure sending request")
        return
        }

        result, err = client.GetGeofenceResponder(resp)
        if err != nil {
        err = autorest.NewErrorWithError(err, "creator.SpatialClient", "GetGeofence", resp, "Failure responding to request")
        return
        }
    ...
    func (client SpatialClient) GetGeofencePreparer(ctx context.Context, deviceID string, udid string, latitude float64, longitude float64, z *float64, userTime *date.Time, searchBuffer *float64, isAsync *bool, mode GeofenceMode) (*http.Request, error) {
        urlParameters := map[string]interface{} {
        "geography": autorest.Encode("path",client.Geography),
        }
...
func (client SpatialClient) GetGreatCircleDistance(ctx context.Context, query string) (result GreatCircleDistanceResponse, err error) {
    ...
    if err != nil {
    err = autorest.NewErrorWithError(err, "creator.SpatialClient", "GetGreatCircleDistance", nil , "Failure preparing request")
    return
    }
        ...
        if err != nil {
        result.Response = autorest.Response{Response: resp}
        err = autorest.NewErrorWithError(err, "creator.SpatialClient", "GetGreatCircleDistance", resp, "Failure sending request")
        return
        }

        result, err = client.GetGreatCircleDistanceResponder(resp)
        if err != nil {
        err = autorest.NewErrorWithError(err, "creator.SpatialClient", "GetGreatCircleDistance", resp, "Failure responding to request")
        return
        }
...
// udid returned by Data Upload API.
    // Parameters:
        ...
        // latitude - the latitude of the location being passed.  Example: 48.36.
        // longitude - the longitude of the location being passed.  Example: -124.63.
func (client SpatialClient) GetPointInPolygon(ctx context.Context, udid string, latitude float64, longitude float64) (result PointInPolygonResponse, err error) {
    if tracing.IsEnabled() {
    ...
    req, err := client.GetPointInPolygonPreparer(ctx, udid, latitude, longitude)
    if err != nil {
    err = autorest.NewErrorWithError(err, "creator.SpatialClient", "GetPointInPolygon", nil , "Failure preparing request")
    return
    }
        ...
        if err != nil {
        result.Response = autorest.Response{Response: resp}
        err = autorest.NewErrorWithError(err, "creator.SpatialClient", "GetPointInPolygon", resp, "Failure sending request")
        return
        }

        result, err = client.GetPointInPolygonResponder(resp)
        if err != nil {
        err = autorest.NewErrorWithError(err, "creator.SpatialClient", "GetPointInPolygon", resp, "Failure responding to request")
        return
        }
    ...
    func (client SpatialClient) GetPointInPolygonPreparer(ctx context.Context, udid string, latitude float64, longitude float64) (*http.Request, error) {
        urlParameters := map[string]interface{} {
        "geography": autorest.Encode("path",client.Geography),
        }
...
autorest.WithQueryParameters(queryParameters))
    ...
    // closes the http.Response Body.
    func (client SpatialClient) GetPointInPolygonResponder(resp *http.Response) (result PointInPolygonResponse, err error) {
            err = autorest.Respond(
            resp,
            azure.WithErrorUnlessStatusCode(http.StatusOK),
            autorest.ByUnmarshallingJSON(&result),
...
func (client SpatialClient) PostBuffer(ctx context.Context, bufferRequestBody BufferRequestBody) (result BufferResponse, err error) {
    if tracing.IsEnabled() {
        ...
        Chain: []validation.Constraint{	{Target: "bufferRequestBody.Geometries.Features", Name: validation.Null, Rule: true, Chain: nil },
        }}}}}); err != nil {
        return result, validation.NewError("creator.SpatialClient", "PostBuffer", err.Error())
        }

        req, err := client.PostBufferPreparer(ctx, bufferRequestBody)
    if err != nil {
    err = autorest.NewErrorWithError(err, "creator.SpatialClient", "PostBuffer", nil , "Failure preparing request")
    return
    }
        ...
        if err != nil {
        result.Response = autorest.Response{Response: resp}
        err = autorest.NewErrorWithError(err, "creator.SpatialClient", "PostBuffer", resp, "Failure sending request")
        return
        }

        result, err = client.PostBufferResponder(resp)
        if err != nil {
        err = autorest.NewErrorWithError(err, "creator.SpatialClient", "PostBuffer", resp, "Failure responding to request")
        return
        }
...
// longitude, and distance in meters from the closest point.
    // Parameters:
        ...
        // numberOfClosestPoints - the number of closest points expected from response. Default: 1, minimum: 1 and
        // maximum: 50
func (client SpatialClient) PostClosestPoint(ctx context.Context, latitude float64, longitude float64, closestPointRequestBody GeoJSONFeatureCollection, numberOfClosestPoints *int32) (result ClosestPointResponse, err error) {
    if tracing.IsEnabled() {
        ...
        { TargetValue: closestPointRequestBody,
         Constraints: []validation.Constraint{	{Target: "closestPointRequestBody.Features", Name: validation.Null, Rule: true, Chain: nil }}}}); err != nil {
        return result, validation.NewError("creator.SpatialClient", "PostClosestPoint", err.Error())
        }

        req, err := client.PostClosestPointPreparer(ctx, latitude, longitude, closestPointRequestBody, numberOfClosestPoints)
    if err != nil {
    err = autorest.NewErrorWithError(err, "creator.SpatialClient", "PostClosestPoint", nil , "Failure preparing request")
    return
    }
        ...
        if err != nil {
        result.Response = autorest.Response{Response: resp}
        err = autorest.NewErrorWithError(err, "creator.SpatialClient", "PostClosestPoint", resp, "Failure sending request")
        return
        }

        result, err = client.PostClosestPointResponder(resp)
        if err != nil {
        err = autorest.NewErrorWithError(err, "creator.SpatialClient", "PostClosestPoint", resp, "Failure responding to request")
        return
        }
    ...
    func (client SpatialClient) PostClosestPointPreparer(ctx context.Context, latitude float64, longitude float64, closestPointRequestBody GeoJSONFeatureCollection, numberOfClosestPoints *int32) (*http.Request, error) {
        urlParameters := map[string]interface{} {
        "geography": autorest.Encode("path",client.Geography),
        }
...
autorest.WithQueryParameters(queryParameters))
    ...
    // closes the http.Response Body.
    func (client SpatialClient) PostClosestPointResponder(resp *http.Response) (result ClosestPointResponse, err error) {
            err = autorest.Respond(
            resp,
            azure.WithErrorUnlessStatusCode(http.StatusOK),
            autorest.ByUnmarshallingJSON(&result),
...
// to enable integration with Event Grid (disabled by default).
    // Parameters:
        ...
        // and do not trigger any event. The default value is false.
        // mode - mode of the geofencing async event mechanism.
func (client SpatialClient) PostGeofence(ctx context.Context, deviceID string, latitude float64, longitude float64, searchGeofenceRequestBody GeoJSONFeatureCollection, z *float64, userTime *date.Time, searchBuffer *float64, isAsync *bool, mode GeofenceMode) (result GeofenceResponse, err error) {
    if tracing.IsEnabled() {
        ...
        { TargetValue: searchGeofenceRequestBody,
         Constraints: []validation.Constraint{	{Target: "searchGeofenceRequestBody.Features", Name: validation.Null, Rule: true, Chain: nil }}}}); err != nil {
        return result, validation.NewError("creator.SpatialClient", "PostGeofence", err.Error())
        }

        req, err := client.PostGeofencePreparer(ctx, deviceID, latitude, longitude, searchGeofenceRequestBody, z, userTime, searchBuffer, isAsync, mode)
    if err != nil {
    err = autorest.NewErrorWithError(err, "creator.SpatialClient", "PostGeofence", nil , "Failure preparing request")
    return
    }
        ...
        if err != nil {
        result.Response = autorest.Response{Response: resp}
        err = autorest.NewErrorWithError(err, "creator.SpatialClient", "PostGeofence", resp, "Failure sending request")
        return
        }

        result, err = client.PostGeofenceResponder(resp)
        if err != nil {
        err = autorest.NewErrorWithError(err, "creator.SpatialClient", "PostGeofence", resp, "Failure responding to request")
        return
        }
    ...
    func (client SpatialClient) PostGeofencePreparer(ctx context.Context, deviceID string, latitude float64, longitude float64, searchGeofenceRequestBody GeoJSONFeatureCollection, z *float64, userTime *date.Time, searchBuffer *float64, isAsync *bool, mode GeofenceMode) (*http.Request, error) {
        urlParameters := map[string]interface{} {
        "geography": autorest.Encode("path",client.Geography),
        }
...
func (client SpatialClient) PostPointInPolygon(ctx context.Context, latitude float64, longitude float64, pointInPolygonRequestBody GeoJSONFeatureCollection) (result PointInPolygonResponse, err error) {
    if tracing.IsEnabled() {
        ...
        { TargetValue: pointInPolygonRequestBody,
         Constraints: []validation.Constraint{	{Target: "pointInPolygonRequestBody.Features", Name: validation.Null, Rule: true, Chain: nil }}}}); err != nil {
        return result, validation.NewError("creator.SpatialClient", "PostPointInPolygon", err.Error())
        }

        req, err := client.PostPointInPolygonPreparer(ctx, latitude, longitude, pointInPolygonRequestBody)
    if err != nil {
    err = autorest.NewErrorWithError(err, "creator.SpatialClient", "PostPointInPolygon", nil , "Failure preparing request")
    return
    }
        ...
        if err != nil {
        result.Response = autorest.Response{Response: resp}
        err = autorest.NewErrorWithError(err, "creator.SpatialClient", "PostPointInPolygon", resp, "Failure sending request")
        return
        }

        result, err = client.PostPointInPolygonResponder(resp)
        if err != nil {
        err = autorest.NewErrorWithError(err, "creator.SpatialClient", "PostPointInPolygon", resp, "Failure responding to request")
        return
        }
    ...
    func (client SpatialClient) PostPointInPolygonPreparer(ctx context.Context, latitude float64, longitude float64, pointInPolygonRequestBody GeoJSONFeatureCollection) (*http.Request, error) {
        urlParameters := map[string]interface{} {
        "geography": autorest.Encode("path",client.Geography),
        }
...
autorest.WithQueryParameters(queryParameters))
    ...
    // closes the http.Response Body.
    func (client SpatialClient) PostPointInPolygonResponder(resp *http.Response) (result PointInPolygonResponse, err error) {
            err = autorest.Respond(
            resp,
            azure.WithErrorUnlessStatusCode(http.StatusOK),
            autorest.ByUnmarshallingJSON(&result),
